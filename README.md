...
<p>This machine learning model was fit to a training set of only 14 images of myself taken by my webcam. Despite the limited training examples, it is still able to generalize quite well to images of different dimensions and other people. </p>
<br/>
<p style="float:left">
